...
export function ExposureScanPage() {
  ...
  useEffect(() => {
    if (!scanning) return;
    const delay = SCAN_STAGE_DELAYS[scanStep];
  ...
  }, [c.stages.length, scanStep, scanning]);
